...
import OperationModification from "./ModifyOperationExpert";
import ProblemsManager from "./ProblemsExpert";

export default function OperationDetails({ operationData, onBackClick }) {
  ...
  // Add state to track if we're in modification view
  ...
  useEffect(() => {
    const calculateMetrics = () => {
      ...
      // Determine status colors based on thresholds from operation object
      ...
      setMetrics({
        ...
        // Use static progression from operation data
  ...
  // Handle return from modify page
  ...
  // Handle save from modify page
  const handleSaveModifications = (updatedOperationData) => {
  ...
  // If in modify view, show the ModifyOperation component
  if (showModifyView) {
    // Create an operation object with only the fields needed by the ModifyOperation component
    const modifyOperationData = {
      id: operation.id,
      cout_prevue: operation.cout_prevue,
      date_debut_prevue: operation.date_debut_prevue,
      date_fin_prevue: operation.date_fin_prevue,
      seuil_vert: operation.seuil_vert,
      seuil_jaune: operation.seuil_jaune,
      seuil_rouge: operation.seuil_rouge,
      progression: operation.progression
    };

    return (
      <OperationModification 
        operationData={modifyOperationData} 
        onSave={handleSaveModifications} 
        onBackClick={handleBackFromModify} 
      />
    );
  }
    ...
    <div className="bg-gray-100 p-6 h-screen">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Left Column */}
          <div>
            {/* Progress Circle - Using static progression from operation object */}
          ...
          <div>
            ...
            <div className="bg-white rounded-lg p-6">
              ...
              <div className="flex justify-center">
                <button 
                  className="bg-orange-400 hover:bg-orange-500 text-white font-medium py-2 px-12 rounded transition-colors"
