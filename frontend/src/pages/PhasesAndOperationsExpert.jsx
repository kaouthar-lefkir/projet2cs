...
import OperationDetails from './OperationDetailsExpert'; // Import the details component
import PhaseDetails from './PhaseDetails'; // Import the phase details component
...
export default function OperationsContent() {
  ...
  if (selectedOperation) {
    return <OperationDetails operationData={selectedOperation} onBackClick={handleBackToList} />;
  }
